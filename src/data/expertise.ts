...
export const expertiseData: ExpertiseCategory[] = [
  ...
  },
  {
    ...
    number: "05",
    navLabel: "05 Digital Marketing",
    titleLine1: "Digital",
    titleLine2: "Marketing",
    description: "SEO, paid campaigns, social media, content, lead generation, email automation, and analytics connected into one measurable growth system.",
    image: "/assets/expertise/digital-marketing.png",
    ctaLabel: "Explore Digital Marketing",
    ctaHref: "/services/digital-marketing",
    services: [
      { label: "Search Engine Optimization", icon: ICONS.search },
      { label: "Paid Advertising", icon: ICONS.trending },
      { label: "Social Media Marketing", icon: ICONS.message },
      { label: "Content Marketing", icon: ICONS.layers },
      { label: "Email Marketing & Nurture", icon: ICONS.flask },
      { label: "Lead Generation Campaigns", icon: ICONS.check },
      { label: "Analytics & Reporting", icon: ICONS.activity },
    ],
  },
];
